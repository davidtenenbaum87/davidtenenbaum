...
class Navbar extends Component {
    ...
    toggleMenu = () => {
        if (this.menu.current.className.includes("hidden")) {
            ...
            this.menu.current.className = "hidden";
        ...
        return(
            <Fragment>
                <nav className="navbar">
                    ...
                    <div className="navbar__david-tenenbaum">
                        <h1><NavLink to="/" >David Tenenbaum</NavLink></h1>
                    </div>
                    <div className="navbar__software-engineer">
                        <h3><NavLink to="/">Software Engineer</NavLink></h3>
                    </div>
                </nav>
                <div className="navbar__menu--hidden" ref={this.menu}>
                    <div className="navbar__menu--visible">
